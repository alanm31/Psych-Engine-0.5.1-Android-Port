function onCreate()
	-- background shit
	makeLuaSprite('bg', 'bg', -300, -300);
	setLuaSpriteScrollFactor('bg', 0.8, 0.8);
	scaleObject('bg', 1.0, 1.0);
	
	makeAnimatedLuaSprite('animsbg', 'animsbg', -300, -500);
	setLuaSpriteScrollFactor('animsbg', 0.8, 0.8);
	scaleObject('animsbg', 1.6, 1.6);

	addAnimationByPrefix('animsbg','animsbg','animation',24,true);
